...
public partial class Grid : ContentView
{
    ...
    (
        ...
        propertyChanged: (bindableObject, oldValue, newValue) =>
        {
            ...
            {
                grid.CoreGrid.RowDefinitions = new();
            }
        }
    );
    ...
    /// <summary>
    /// Gets or sets the <see cref="ColumnDefinitionCollection"/> for defining columns item templates.
    /// </summary>
    ...
    private void OnColumnsChanged(object sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        switch (e.Action)
        {
            ...
            case NotifyCollectionChangedAction.Reset:
                CoreGrid.ColumnDefinitions = new();
                break;
        }
    }
    ...
    private void UpdateColumns()
    {
        if
        (
            CoreGrid.ColumnDefinitions == null
            ||
    ...
    (
        ...
        propertyChanged: (bindableObject, oldValue, newValue) =>
        {
            if (bindableObject is Grid grid && newValue is IEnumerable<object> values)
            {
                grid.Populate();
            }
        }
